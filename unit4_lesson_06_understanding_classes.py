...
def test_classes_bound_and_unbound_methods():
    ...
    assert "push" == TestQueue.push.__name__   #unbound method
    assert "push" == q1_push.__name__      #bound method, is associated with an instance
...
class Person:
    def __init__(self,name,age,height,weight):
        self.name=name
        self.age=age
        self.height=float(height)*0.3048
