...
def get_green_length(segments):
    if segments==None:
        return None
    list2 = [list(range(i, j)) for (i, j) in segments]
    list3 = [i for j in range(len(list2)) for i in list2[j]]
    #del list2
    set1=set(list3)
    #del list3
    #print(len(set1))
...
def test_get_green_length():
    ...
    print(get_green_length([(20, 21) ,(5,11), (45, 47)]))
    #befor=time.time()
    #print(get_green_length([(0,1000),(12000000,15000000),(140000,150000)]))
    #print(time.time()-befor)