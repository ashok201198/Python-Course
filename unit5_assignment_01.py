...
def test_de_dup_and_sort_student():
    assert ["ashok", "rajesh","vema"] == de_dup_and_sort(["vema", "ashok", "rajesh", "ashok"]*5)
    assert []==de_dup_and_sort(None)
    assert [3,4,5]==de_dup_and_sort(list(range(6)[3:]))
